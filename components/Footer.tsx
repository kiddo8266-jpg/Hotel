            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-20">
                ...
                <div className="md:col-span-3 space-y-6">
                    ...
                    <div className="flex flex-wrap gap-3">
                        <a href="https://facebook.com/nljosephineshotel" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center hover:bg-[#C9A05B] hover:text-[#0F2C23] transition-all duration-300 group">
                            <Facebook size={16} className="text-gray-400 group-hover:text-[#0F2C23] transition-colors" />
                        </a>
                        <a href="https://instagram.com/nljosephineshotel" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center hover:bg-[#C9A05B] hover:text-[#0F2C23] transition-all duration-300 group">
                            <Instagram size={16} className="text-gray-400 group-hover:text-[#0F2C23] transition-colors" />
                        </a>
                        <a href="https://twitter.com/nljosephineshotel" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center hover:bg-[#C9A05B] hover:text-[#0F2C23] transition-all duration-300 group">
                        ...
                        <a href="https://youtube.com/@nljosephineshotel" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center hover:bg-[#C9A05B] hover:text-[#0F2C23] transition-all duration-300 group">
                            <Youtube size={16} className="text-gray-400 group-hover:text-[#0F2C23] transition-colors" />
                        </a>
                        <a href="https://tiktok.com/@nljosephineshotel" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="w-10 h-10 bg-white/5 rounded-full flex items-center justify-center hover:bg-[#C9A05B] hover:text-[#0F2C23] transition-all duration-300 group">
                            <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" aria-hidden="true" className="text-gray-400 group-hover:text-[#0F2C23] transition-colors">
