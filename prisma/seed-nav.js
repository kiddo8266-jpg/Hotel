...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var count, _i, defaultLinks_1, link;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log('Checking for existing navigation links...');
                    return [4 /*yield*/, prisma.navigationLink.count()];
                case 1:
                    count = _a.sent();
                    if (!(count === 0)) return [3 /*break*/, 6];
                    console.log('Seeding default navigation links...');
                    _i = 0, defaultLinks_1 = defaultLinks;
                    _a.label = 2;
                case 2:
                    if (!(_i < defaultLinks_1.length)) return [3 /*break*/, 5];
                    link = defaultLinks_1[_i];
                    return [4 /*yield*/, prisma.navigationLink.create({
                            data: {
                                label: link.label,
                                href: link.href,
